...
#define CG_SURFACE_TOKEN_HINT_PREFIX "cage-surface-v1:"
#define CG_SURFACE_TOKEN_HINT_SIZE (sizeof(CG_SURFACE_TOKEN_HINT_PREFIX) - 1 + CG_SURFACE_TOKEN_SIZE * 2 + 1)

bool cg_surface_token_hint_encode(const struct cg_surface_token *token, char *hint_out, size_t hint_capacity);
